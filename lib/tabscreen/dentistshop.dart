...
class DentistShop extends StatefulWidget {
  const DentistShop({super.key});

  @override
  State<DentistShop> createState() => _DentistShopState();
}

class _DentistShopState extends State<DentistShop> {
  var rating = 0.0;
  @override
  void initState() {
